...
<div class="container-fluid vh-100">
    <div class="row">
        ...
        <div class="right col-md-6 bg-black  d-flex flex-column justify-content-center align-items-center">
            <p class="right-first-p fw-bold ">E B O O K</p>
                <p class="fs-1 text-light fw-bold">How to Build a Tech Talent Brand : <span style="color: darkgrey">The Definitive Guide</span></p>
                <p class="right-third-p text-light">
                ...
                <p class="right-fourth-p text-light">"John Alex - 2021"</p>
        </div>
    </div>
  </div>
</main>
