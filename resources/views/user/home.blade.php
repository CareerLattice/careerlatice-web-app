        ...
        <div class="card">
            <div class="card-body">
                    ...
                    <div class="col-12 col-md-7 ms-3">
                        ...
                        @if (Auth::user()->role == 'applier')
                            ...
                            @if ($applier->cv_url != null && Storage::disk('google')->exists($applier->cv_url))
                                ...
                                @if ($cv)
                                    <a href={{"https://drive.google.com/file/d/{$cv['extraMetadata']['id']}/preview"}} class="btn btn-outline-primary" target="_blank" style="width: 10%; max-width: 150px;min-width: 90px;">{{__('lang.View CV')}}</a>
                                @endif
                            @endif
                        @endif
                    </div>
                ...
                <div class="tab-content" id="companyTabContent">
                    <h5 class="section-title mb-3" style="font-size: 1.5rem; color: #192a51; font-weight: 600;">{{__('lang.description')}}</h5>
                    ...
                    <p class="mb-1"><strong>{{__('lang.email')}} </strong>{{$applier->user->email}}</p>
                    <p class="mb-1"><strong>{{__('lang.phoneNumber')}}  </strong>{{$applier->user->phone_number}}</p>
                    <p class="mb-1"><strong>{{__('lang.address')}} </strong>{{$applier->address}}</p>
                    <p class="mb-1"><strong>{{__('lang.birthDate')}} </strong>{{\Carbon\Carbon::parse($applier->birth_date)->format('d F Y')}}</p>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                ...
                @forelse ($applier->educations as $education)
                    ...
                    <div class="col-md-12 d-flex flex-column justify-content-center ms-3">
                        <h5 class="section-title mb-2" style="font-size: 1.5rem; color: #192a51; font-weight: 600;">{{__('lang.description')}}</h5>
