                ...
                <div class="col-sm-8 col-md-4 mb-4">
                    <div class="card job-card" style="box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); border-radius: 8px;">
                        <div class="card-body d-flex flex-column">
                            <h5 class="card-title fw-bold mb-2" style="color: #192a51;">{{$jobApplication->name }}</h5>
                            <p class="card-text text-muted">{{$jobApplication->title}}</p>
                            <p class="card-text">
                                Applied on {{$jobApplication->created_at}}
                            </p>
                        </div>
                    </div>
                </div>
