                            ...
                            <div class="col-md-8">
                                <div class="card-body p-3">
                                    ...
                                    <div class="mt-2 d-flex flex-column flex-md-row align-items-center gap-2">
                                        {{-- <a href="{{route('user.job', ['job' => $job])}}" class="btn btn-primary btn-lg w-100 w-md-auto d-flex justify-content-center align-items-center" style="padding: 0.5rem 1.5rem; font-size: 1.1rem;"> --}}
